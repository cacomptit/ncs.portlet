...
public class DictItemServiceClp implements DictItemService {
	public DictItemServiceClp(InvokableService invokableService) {
		...
		_methodName4 = "getDictItemInuseByItemCode";

		_methodParameterTypes4 = new String[] { "long", "java.lang.String" };

		_methodName5 = "getDictItemsByParentItemId";

		_methodParameterTypes5 = new String[] { "long" };

		_methodName6 = "getDictItemsByDictCollectionId";

		_methodParameterTypes6 = new String[] { "long" };

		_methodName7 = "getDictItemsInUseByDictCollectionIdAndParentItemId";

		_methodParameterTypes7 = new String[] { "long", "long" };

		_methodName8 = "getDictItemsInUseByDictCollectionIdAndParentItemIdDataSource";
	...
	public java.util.List<org.opencps.datamgt.model.DictItem> getDictItemsByParentItemId(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName5,
					_methodParameterTypes5, new Object[] { parentItemId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<org.opencps.datamgt.model.DictItem> getDictItemsByDictCollectionId(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName6,
					_methodParameterTypes6, new Object[] { dictCollectionId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
